...
이 메서드는 수업 과목명과 성적을 인자로 받아 Course 객체를 생성하고 학생의 과목 배열에 추가합니다.
...
public class Test {
    public static void main(String[] args) {
        ...
        Student.Course[] courses = student.getCourseList();
        for (int i = 0; i < student.getIdx(); i++) {
